      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Fit polynomial
          auto coeffs = polyfit(new_x, new_y, 3); //3rd order polynomial
          ...
          // CTE and EPSI
          double cte = polyeval(coeffs, x_proj) - y_proj;
          ...
          double steer_value = output[1];
          double throttle_value = output[0];
